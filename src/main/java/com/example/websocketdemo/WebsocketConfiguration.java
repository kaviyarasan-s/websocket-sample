...
public class WebsocketConfiguration implements WebSocketConfigurer {
	...
	public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
		...
		registry.addHandler(new WebsocketTestHandler(), "/customwebsocket").addInterceptors(websocketTestInterceptor());
	}

	@Bean
	public HandshakeInterceptor websocketTestInterceptor() {
